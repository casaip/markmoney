...
export default function WeeklyBarChart({ data }: Props) {
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-gray-700 mb-2">Last 4 Weeks</h3>
      <div className="h-32">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 0, right: 0, bottom: 0, left: -20 }}>
            ...
            />
            <Bar dataKey="expense" fill="#ef4444" radius={[2, 2, 0, 0]} name="Spent" maxBarSize={32} />
            <Bar dataKey="income" fill="#10b981" radius={[2, 2, 0, 0]} name="Income" maxBarSize={32} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
